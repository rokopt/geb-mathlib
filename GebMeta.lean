...
def classicalAllowedModules : NameSet :=
  [`GebTests.Prototypes.AxiomLinterClassicalFixture,
   ...
   `Geb.Prototypes.Computability.Oitavem.Machine.Generated,
   `Geb.Prototypes.Computability.Oitavem.Machine.Allocate,
   `Geb.Prototypes.Computability.Oitavem.Machine.Reader,
   `Geb.Prototypes.Computability.Oitavem.Machine.Compose,
   `Geb.Prototypes.Computability.Oitavem.Machine.Counter,
   `Geb.Prototypes.Computability.Oitavem.Machine.Segment,
   `Geb.Prototypes.Computability.Oitavem.Machine.Subtraction,
   `Geb.Prototypes.Computability.Oitavem.Machine.MapOutput,
   `Geb.Prototypes.Computability.Oitavem.Machine.Initial,
   `Geb.Prototypes.Computability.Oitavem.Machine.Capture,
   ...
   `Geb.Prototypes.Computability.Oitavem.Machine.Realizer.Compile,
   `Geb.Prototypes.Computability.Oitavem.Machine.Realizer.Loop,
   `Geb.Prototypes.Computability.Oitavem.Machine.Realizer.Retained,
   `Geb.Prototypes.Computability.Oitavem.Machine.Realizer.Recursion,
   ...
   `Geb.Prototypes.Computability.SizeBounded.Machine.Loop.Phases,
   `Geb.Prototypes.Computability.SizeBounded.Machine.Loop.Iter,

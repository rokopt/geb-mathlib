...
{cite}`Kristiansen2005` Lemma 4.5: for every function of the algebra
...
form of {cite}`Kristiansen2005` Lemma 4.5's induction. -/
...
/-- {cite}`Kristiansen2005` Lemma 4.5: a value longer than the expression's

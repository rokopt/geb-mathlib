...
{cite}`AlurFreilichRaghothaman2014`, Section III. This is an application of those
...
and a pairing with logspace decoding appear in {cite}`CenzerDowneyRemmelUddin2008`,

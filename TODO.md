...
- Presentations over presheaf free monads, their quotient by `coeq` of
  `Geb/Prototypes/QuotientPRA/Basic.lean`, and agreement with the
  ...
  describes; `Geb/Prototypes/Definition/Presentation/` carries the
  univariate and slice layers. Well-founded blocks as presentations with
  constants, through `WFBlock.existsUnique_isSolution`.
